...
- Upload the asset and its modifications to both public and private worlds for personal use.
...
- Upload the asset to other users' accounts, as part of a world package.
